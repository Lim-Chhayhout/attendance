...
@section('title', 'My Dashboard - Home')
        ...
        <div class="con">
            <div class="row">
                <div class="block-1 box">
                    ...
                    <div class="message">
                        Welcome back, <span>Lim Chhayhout!</span>
                    </div>
                    <div class="des" id="show-datetime">
                        
                    </div>
                </div>
                <div class="block-2 box">
                    <div class="pro-icon icon">
                        <img src="{{ asset('assets/global/icons/main-clock-regular.svg')}}">
                    </div>
